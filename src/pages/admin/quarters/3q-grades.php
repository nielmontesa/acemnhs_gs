                ...
                if ($gradesheet_result->num_rows > 0) {
                    ...
                    <div class="flex items-center justify-between  pt-2">
                        ...
                        <div class="flex items-center content-center gap-2">
                            ...
                            <div class="btn-group btn-group-scrollable">
                                ...
                                <input type="radio" name="quarterFilter" data-content="3" class="btn" checked />
                    ...
                    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                        ...
                        if (isset($_POST['gradesheet_id'])) {
                            ...
                            $quarter = 3; // The value you want to insert for the quarter column
                    ...
                    <thead>
                        <tr>
                            ...
                            if (isset($_GET['section_id']) && isset($_GET['gradesheet_id'])) {
                                ...
                                $activity_sql = "SELECT * FROM activity WHERE gradesheet_id = $gradesheet_id AND quarter = 3 ORDER BY 
                             CASE activity_type 
